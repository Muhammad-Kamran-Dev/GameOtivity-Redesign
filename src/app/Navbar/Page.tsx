...
export const Navbar = () => {
  ...
  return (
    <header className="flex items-center justify-between w-full px-10 py-6 overflow-x-auto shadow-2xl gradient-dark">
      <div className="logo">
        <Image
      ...
      <nav
        className={`md:hidden absolute top-0 bottom-0 left-0 right-0 flex flex-col items-center gap-20 justify-center transform 
        ${
      ...
      >
        <ul className="flex flex-col items-center justify-center gap-10 text-4xl font-bold ">
          ...
          >
            ...
            >
              <path
                className="hover:fill-orange-500 transition-fill .3s ease-in "
                fill="#fff"
          ...
          <li className="relative">
            <Link
              href="/"
              className="after:content-[''] after:absolute after:-bottom-1 after:left-1/2 after:bg-orange-500 after:w-0 after:h-1 after:rounded-full after:transform after:-translate-x-1/2 hover:after:w-full after:transition-width .3s ease-in"
            >
              Home
            </Link>
          </li>
        ...
        <div className="relative flex items-center justify-center h-16 whitepaper">
          ...
          />
          <p className="absolute text-4xl text-center after:content-[''] after:absolute after:-bottom-1 after:left-1/2 after:bg-orange-500 after:w-0 after:h-1 after:rounded-full after:transform after:-translate-x-1/2 hover:after:w-full after:transition-width .3s ease-in">
            WhitePaper
          </p>
        </div>
      </nav>
      ...
      <nav className="hidden gap-10 md:flex">
        ...
        <div className="relative flex items-center justify-center h-10 whitepaper">
          <Image
            ...
            alt="Svg Shape for img"
          />
          <p className="absolute text-2xl text-center after:content-[''] after:absolute after:-bottom-1 after:left-1/2 after:bg-orange-500 after:w-0 after:h-1 after:rounded-full after:transform after:-translate-x-1/2 hover:after:w-full after:transition-width .3s ease-in">
            WhitePaper
          </p>
        </div>
      </nav>
